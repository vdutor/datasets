...
PATH_OFFICE = "/home/vincent/pio/deconvgp/data/uci/"

PATH_MAC = "/Users/vincent/pio/deconvgp/data/uci/"

PATH_CLUSTER = "/home/ubuntu/deconvgp/data/uci/"

if platform.node() == "vincent-desktop":
    print("Office")
    PATH = PATH_OFFICE
elif platform.node() == "Vincents-MacBook-Pro.local":
    print("Mac")
    PATH = PATH_MAC
else:
    print("cluster")
...
class Dataset(object):
    def __init__(self, name, N, D, type, data_path=PATH): #
...
class Energy(Dataset):
    ...
    def download_data(self):
        ...
        data = pandas.read_excel(url).values[:, :-1]
...
class Yacht(Dataset):
    ...
    def download_data(self):
        ...
        data = pandas.read_fwf(url, header=None).values[:-1, :]
...
if __name__ == "__main__":
    ...
    for d in datasets.items():
        ...
        t = d[1].type
        print(t)
        N = d[1].get_data()["X"].shape
        Ns = d[1].get_data()["Xs"].shape
        print(N, Ns)
